# Twitter Retweeting, Favorite and Tweet new followers bot
...
![](/re-tweeter-bot/src/images/c9-hidden-files-check.gif)
...
![](/re-tweeter-bot/src/images/c9-strings-config.png)
...
![](/re-tweeter-bot/src/images/heroku-build.png)
